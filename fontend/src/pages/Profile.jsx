...
const Profile = () => {
  ...
  let [frontendImage, setFrontendImage] = useState(userData.image || download);
  ...
  return (
    <div className="w-full h-[100vh] bg-slate-200 flex flex-col justify-center items-center gap-[20px]">
      ...
      <div
        className=" bg-white   border-4 rounded-full border-[#20c7ff] shadow-gray-400 shadow-lg  relative "
      ...
      >
        ...
        <div className="absolute bottom-4 text-gray-700 right-4 w-[35px] h-[35px] rounded-full bg-[#20c7ff] justify-center items-center flex shadow-gray-400 shadow-lg">
